AliAnalysisTaskQAMultistrange *AddTaskQAMultistrange( Bool_t   eventselectionOff       = kFALSE,
                                                      Bool_t   isMC                    = kFALSE,
                                                      Bool_t   relaunchV0CascVertexers = kFALSE,
                                                      Int_t    minnTPCcls              = 70,
   ...
   taskcheckcascade->SetEventSelectionOff          (eventselectionOff);
   taskcheckcascade->SetIsMC                       (isMC);
   taskcheckcascade->SetRelaunchV0CascVertexers    (relaunchV0CascVertexers);
